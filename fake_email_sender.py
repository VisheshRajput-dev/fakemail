...
class FakeEmailSender:
    ...
    def interactive_mode(self):
        ...
        # Try getpass first, fallback to regular input if it fails
        try:
            password = getpass.getpass("Enter your Gmail password (or App Password): ")
        except (EOFError, KeyboardInterrupt):
            print("\n⚠️  getpass failed, using regular input (password will be visible)")
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == "--help" or sys.argv[1] == "-h":
            print("Fake Email Sender")
            print("Usage:")
            print("  python fake_email_sender.py                    # Interactive mode")
            print("  python fake_email_sender.py --help             # Show this help")
